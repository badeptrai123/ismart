                        ...
                        <div class="wp-inner">
                            ...
                            <div id="main-menu-wp" class="fl-right">
                                <ul id="main-menu" class="clearfix">
                                    ...
                                    <li>
                                        <a href="?mod=product&action=category_product" title="">Sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="?mod=page&controller=index&action=blog" title="">Blog</a>
                                    </li>
                                    <li>
                                        <a href="?mod=page&controller=index&action=detail_blog" title="">Giới thiệu</a>
                                    </li>
                                    <li>
                                        <a href="?mod=page&controller=index&action=detail_blog" title="">Liên hệ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
