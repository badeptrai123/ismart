...
// if(!is_login() && get_action()!='login' && get_action()!='register' && get_action()!='active' && get_action()!='loss_pass' && get_action()!='reset' && get_action()!='reset_success' && get_action()!='update_pass'){
